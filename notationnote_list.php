...
/**
 *   	\file       notationnote_list.php
 *		\ingroup    notation
 *		\brief      List page for notationnote
 */
...
if ($enablepermissioncheck) {
	...
	$permissiontoadd = $user->hasRight("notation", "notationnote", "write");
	$permissiontodelete = $user->hasRight("notation", "notationnote", "delete");
} else {
	$permissiontoread = 1;
	$permissiontoadd = 1;
...
if (!isModEnabled("notation")) accessforbidden('Module not enabled');
...
if (empty($reshook)) {
	...
	// Mass actions
	$objectclass = 'NotationNote';
	$objectlabel = 'NotationNote';
	$uploaddir = $conf->notation->dir_output;
...
//$help_url = "EN:Module_NotationNote|FR:Module_NotationNote_FR|ES:Módulo_NotationNote";
$help_url = '';
$title = $langs->trans("NotationNotes");
$morejs = array();
$morecss = array();
...
if ($num == 1 && getDolGlobalString('MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE') && $search_all && !$page) {
	...
	$id = $obj->rowid;
	header("Location: ".dol_buildpath('/notation/notationnote_card.php', 1).'?id='.$id);
	exit;
}
...
if (in_array('builddoc', $arrayofmassactions) && ($nbtotalofrecords === '' || $nbtotalofrecords)) {
	...
	print $formfile->showdocuments('massfilesarea_notation', '', $filedir, $urlsource, 0, $delallowed, '', 1, 1, 0, 48, 1, $param, $title, '', '', '', null, $hidegeneratedfilelistifempty);
}

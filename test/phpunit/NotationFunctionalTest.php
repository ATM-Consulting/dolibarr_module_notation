...
/**
 * \file    test/phpunit/NotationFunctionalTest.php
 * \ingroup notation
 ...
 *
 * @package Testnotation
 */
class NotationFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/notation/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('notation/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/notation/admin/about.php');
		$this->authenticate();
		return $this->assertContains('notation/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('notationwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modNotation_NotationTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modNotation_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}

...
/**
 * \file    core/triggers/interface_99_modNotation_NotationTriggers.class.php
 * \ingroup notation
 ...
 *      - interface_99_modNotation_MyTrigger.class.php
...
/**
 *  Class of triggers for Notation module
 */
class InterfaceNotationTriggers extends DolibarrTriggers
{
	/**
	 * Constructor
	 *
	...
	public function __construct($db)
	{
		...
		$this->family = "demo";
		$this->description = "Notation triggers.";
		// 'development', 'experimental', 'dolibarr' or version
		$this->version = 'development';
		$this->picto = 'notation@notation';
	}

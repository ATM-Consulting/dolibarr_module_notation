...
ALTER TABLE llx_notation_notationnote ADD INDEX idx_notation_notationnote_rowid (rowid);
...
--ALTER TABLE llx_notation_notationnote ADD CONSTRAINT llx_notation_notationnote_fk_field FOREIGN KEY (fk_field) REFERENCES llx_notation_myotherobject(rowid);

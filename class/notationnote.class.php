...
class NotationNote extends CommonObject
{
	...
	public $fields=array(
		...
		'note' => array('type'=>'real', 'label'=>'note', 'enabled'=>'1', 'position'=>4, 'notnull'=>0, 'visible'=>1, 'default'=>'0', 'isameasure'=>'1', 'css'=>'maxwidth75imp', 'help'=>"Help text for note", 'validate'=>'1',),
		'fk_session' => array('type'=>'integer:Agsession:agefodd/class/agefodd_session.class.php', 'label'=>'Session', 'picto'=>'Session', 'enabled'=>'1', 'position'=>2, 'notnull'=>-1, 'visible'=>1, 'index'=>1, 'css'=>'maxwidth500 widthcentpercentminusxx', 'help'=>"OrganizationEventLinkToThirdParty", 'validate'=>'1',),
		'fk_trainee' => array('type'=>'integer:Agefodd_Stagiaire:agefodd/class/agefodd_stagiaire.class.php:name::card', 'label'=>'AgfFichePresByTraineeTraineeTitleM', 'enabled'=>1, 'position'=>3, 'notnull'=>0, 'visible'=>1),
	);
	...
	public function getNomUrl($withpicto = 0, $option = '', $notooltip = 0, $morecss = '', $save_lastsearch_value = -1)
	{
		...
		$url = dol_buildpath('/notation/notationnote_card.php', 1).'?id='.$this->id;
